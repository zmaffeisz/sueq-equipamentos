...
ALTER TABLE "public"."empenho_itens" OWNER TO "postgres";
...
ALTER TABLE "public"."nota_fiscal_itens" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."sancoes_administrativas" (
    ...
    "contrato" "text",
    "tipo" "text" NOT NULL,
    "status" "text" DEFAULT 'Em an??lise'::"text" NOT NULL,
    ...
    "created_at" timestamp without time zone DEFAULT "now"(),
    "contrato_id" integer,
    CONSTRAINT "sancoes_status_valido" CHECK (("status" = ANY (ARRAY['Em an??lise'::"text", 'Notificada'::"text", 'Em defesa'::"text", 'Aplicada'::"text", 'Encerrada'::"text", 'Cancelada'::"text"]))),
    CONSTRAINT "sancoes_tipo_valido" CHECK (("tipo" = ANY (ARRAY['Advert??ncia'::"text", 'Multa'::"text", 'Suspens??o'::"text", 'Impedimento de licitar'::"text", 'Declara????o de inidoneidade'::"text"]))),
...
ALTER TABLE ONLY "public"."empenho_itens"
...
CREATE INDEX "idx_atas_execucao_emenda" ON "public"."atas_execucao" USING "btree" ("emenda_id") WHERE ("emenda_id" IS NOT NULL);
...
CREATE INDEX "idx_empenho_itens_emenda_item" ON "public"."empenho_itens" USING "btree" ("emenda_item_id");



CREATE INDEX "idx_empenho_itens_empenho" ON "public"."empenho_itens" USING "btree" ("empenho_id");



CREATE INDEX "idx_empenho_itens_item" ON "public"."empenho_itens" USING "btree" ("item_id");
...
CREATE INDEX "idx_empenhos_emenda" ON "public"."empenhos" USING "btree" ("emenda_id");
...
CREATE INDEX "idx_empenhos_numero_ano" ON "public"."empenhos" USING "btree" ("numero", "ano");



CREATE INDEX "idx_empenhos_numero_norm_ano" ON "public"."empenhos" USING "btree" ("numero_normalizado", "ano");



CREATE INDEX "idx_empenhos_processo" ON "public"."empenhos" USING "btree" ("processo_id");
...
CREATE INDEX "idx_itens_entregas_empenho" ON "public"."itens_entregas" USING "btree" ("empenho_id");



CREATE INDEX "idx_itens_entregas_nota_fiscal" ON "public"."itens_entregas" USING "btree" ("nota_fiscal_id");



CREATE INDEX "idx_itens_origem" ON "public"."itens" USING "btree" ("item_origem_id") WHERE ("item_origem_id" IS NOT NULL);



CREATE INDEX "idx_nf_itens_emenda_item" ON "public"."nota_fiscal_itens" USING "btree" ("emenda_item_id");



CREATE INDEX "idx_nf_itens_empenho" ON "public"."nota_fiscal_itens" USING "btree" ("empenho_id");



CREATE INDEX "idx_nf_itens_item" ON "public"."nota_fiscal_itens" USING "btree" ("item_id");



CREATE INDEX "idx_nf_itens_nf" ON "public"."nota_fiscal_itens" USING "btree" ("nota_fiscal_id");



CREATE INDEX "idx_notas_fiscais_chave" ON "public"."notas_fiscais" USING "btree" ("chave_acesso");



CREATE INDEX "idx_notas_fiscais_contrato" ON "public"."notas_fiscais" USING "btree" ("contrato_id");



CREATE INDEX "idx_notas_fiscais_emenda" ON "public"."notas_fiscais" USING "btree" ("emenda_id");



CREATE INDEX "idx_notas_fiscais_fornecedor" ON "public"."notas_fiscais" USING "btree" ("fornecedor_id");



CREATE INDEX "idx_notas_fiscais_numero" ON "public"."notas_fiscais" USING "btree" ("numero");



CREATE INDEX "idx_notas_fiscais_numero_norm" ON "public"."notas_fiscais" USING "btree" ("numero_normalizado");



CREATE INDEX "idx_notas_fiscais_processo" ON "public"."notas_fiscais" USING "btree" ("processo_id");
...
CREATE INDEX "itens_emenda_item_idx" ON "public"."itens" USING "btree" ("emenda_item_id");



CREATE INDEX "itens_entregas_item_idx" ON "public"."itens_entregas" USING "btree" ("item_id");



CREATE INDEX "itens_processo_idx" ON "public"."itens" USING "btree" ("processo_id");



CREATE INDEX "itens_status_idx" ON "public"."itens" USING "btree" ("status");



CREATE UNIQUE INDEX "uq_empenho_itens_empenho_item" ON "public"."empenho_itens" USING "btree" ("empenho_id", "item_id") WHERE ("item_id" IS NOT NULL);



CREATE UNIQUE INDEX "uq_nf_itens_nf_item_empenho" ON "public"."nota_fiscal_itens" USING "btree" ("nota_fiscal_id", "item_id", COALESCE("empenho_id", '00000000-0000-0000-0000-000000000000'::"uuid")) WHERE ("item_id" IS NOT NULL);
...
ALTER TABLE ONLY "public"."atas_execucao"
    ADD CONSTRAINT "atas_execucao_emenda_id_fkey" FOREIGN KEY ("emenda_id") REFERENCES "public"."emendas"("id");



ALTER TABLE ONLY "public"."atas_execucao"
    ADD CONSTRAINT "atas_execucao_emenda_item_id_fkey" FOREIGN KEY ("emenda_item_id") REFERENCES "public"."emenda_itens"("id");
...
ALTER TABLE ONLY "public"."empenho_itens"
    ADD CONSTRAINT "empenho_itens_emenda_id_fkey" FOREIGN KEY ("emenda_id") REFERENCES "public"."emendas"("id");



ALTER TABLE ONLY "public"."empenho_itens"
    ADD CONSTRAINT "empenho_itens_emenda_item_id_fkey" FOREIGN KEY ("emenda_item_id") REFERENCES "public"."emenda_itens"("id");



ALTER TABLE ONLY "public"."empenho_itens"
    ADD CONSTRAINT "empenho_itens_empenho_id_fkey" FOREIGN KEY ("empenho_id") REFERENCES "public"."empenhos"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."empenho_itens"
    ADD CONSTRAINT "empenho_itens_item_id_fkey" FOREIGN KEY ("item_id") REFERENCES "public"."itens"("id");
...
ALTER TABLE ONLY "public"."empenhos"
    ADD CONSTRAINT "empenhos_emenda_id_fkey" FOREIGN KEY ("emenda_id") REFERENCES "public"."emendas"("id");
...
ALTER TABLE ONLY "public"."empenhos"
    ADD CONSTRAINT "empenhos_processo_id_fkey" FOREIGN KEY ("processo_id") REFERENCES "public"."processos"("id");
...
ALTER TABLE ONLY "public"."itens_entregas"
    ADD CONSTRAINT "itens_entregas_empenho_id_fkey" FOREIGN KEY ("empenho_id") REFERENCES "public"."empenhos"("id");
...
ALTER TABLE ONLY "public"."itens_entregas"
    ADD CONSTRAINT "itens_entregas_nota_fiscal_id_fkey" FOREIGN KEY ("nota_fiscal_id") REFERENCES "public"."notas_fiscais"("id");
...
ALTER TABLE ONLY "public"."itens"
    ADD CONSTRAINT "itens_item_origem_id_fkey" FOREIGN KEY ("item_origem_id") REFERENCES "public"."itens"("id");
...
ALTER TABLE ONLY "public"."nota_fiscal_itens"
    ADD CONSTRAINT "nota_fiscal_itens_emenda_id_fkey" FOREIGN KEY ("emenda_id") REFERENCES "public"."emendas"("id");



ALTER TABLE ONLY "public"."nota_fiscal_itens"
    ADD CONSTRAINT "nota_fiscal_itens_emenda_item_id_fkey" FOREIGN KEY ("emenda_item_id") REFERENCES "public"."emenda_itens"("id");



ALTER TABLE ONLY "public"."nota_fiscal_itens"
    ADD CONSTRAINT "nota_fiscal_itens_empenho_id_fkey" FOREIGN KEY ("empenho_id") REFERENCES "public"."empenhos"("id");



ALTER TABLE ONLY "public"."nota_fiscal_itens"
    ADD CONSTRAINT "nota_fiscal_itens_item_id_fkey" FOREIGN KEY ("item_id") REFERENCES "public"."itens"("id");



ALTER TABLE ONLY "public"."nota_fiscal_itens"
    ADD CONSTRAINT "nota_fiscal_itens_nota_fiscal_id_fkey" FOREIGN KEY ("nota_fiscal_id") REFERENCES "public"."notas_fiscais"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."notas_fiscais"
    ADD CONSTRAINT "notas_fiscais_contrato_id_fkey" FOREIGN KEY ("contrato_id") REFERENCES "public"."contratos"("id");



ALTER TABLE ONLY "public"."notas_fiscais"
    ADD CONSTRAINT "notas_fiscais_emenda_id_fkey" FOREIGN KEY ("emenda_id") REFERENCES "public"."emendas"("id");
...
ALTER TABLE ONLY "public"."notas_fiscais"
    ADD CONSTRAINT "notas_fiscais_processo_id_fkey" FOREIGN KEY ("processo_id") REFERENCES "public"."processos"("id");
...
CREATE POLICY "escrita empenho_itens" ON "public"."empenho_itens" USING (("public"."can_access_tab"('itens'::"text", 'edit'::"text") OR "public"."can_access_tab"('contratos'::"text", 'edit'::"text") OR "public"."can_access_tab"('dashboard'::"text", 'edit'::"text")));



CREATE POLICY "escrita empenhos" ON "public"."empenhos" USING (("public"."can_access_tab"('itens'::"text", 'edit'::"text") OR "public"."can_access_tab"('contratos'::"text", 'edit'::"text") OR "public"."can_access_tab"('dashboard'::"text", 'edit'::"text")));



CREATE POLICY "escrita itens" ON "public"."itens" USING (("public"."can_access_tab"('itens'::"text", 'edit'::"text") OR "public"."can_access_tab"('contratos'::"text", 'edit'::"text") OR "public"."can_access_tab"('dashboard'::"text", 'edit'::"text")));



CREATE POLICY "escrita itens_entregas" ON "public"."itens_entregas" USING (("public"."can_access_tab"('itens'::"text", 'edit'::"text") OR "public"."can_access_tab"('contratos'::"text", 'edit'::"text") OR "public"."can_access_tab"('dashboard'::"text", 'edit'::"text") OR "public"."can_access_tab"('atas'::"text", 'edit'::"text")));



CREATE POLICY "escrita nota_fiscal_itens" ON "public"."nota_fiscal_itens" USING (("public"."can_access_tab"('itens'::"text", 'edit'::"text") OR "public"."can_access_tab"('contratos'::"text", 'edit'::"text") OR "public"."can_access_tab"('dashboard'::"text", 'edit'::"text")));



CREATE POLICY "escrita notas_fiscais" ON "public"."notas_fiscais" USING (("public"."can_access_tab"('itens'::"text", 'edit'::"text") OR "public"."can_access_tab"('contratos'::"text", 'edit'::"text") OR "public"."can_access_tab"('dashboard'::"text", 'edit'::"text")));
...
CREATE POLICY "leitura autenticada empenho_itens" ON "public"."empenho_itens" FOR SELECT TO "authenticated" USING (true);



CREATE POLICY "leitura autenticada empenhos" ON "public"."empenhos" FOR SELECT TO "authenticated" USING (true);
...
CREATE POLICY "leitura autenticada nota_fiscal_itens" ON "public"."nota_fiscal_itens" FOR SELECT TO "authenticated" USING (true);



CREATE POLICY "leitura autenticada notas_fiscais" ON "public"."notas_fiscais" FOR SELECT TO "authenticated" USING (true);
...
GRANT ALL ON TABLE "public"."empenho_itens" TO "authenticated";
GRANT ALL ON TABLE "public"."empenho_itens" TO "service_role";



GRANT ALL ON TABLE "public"."empenhos" TO "authenticated";
GRANT ALL ON TABLE "public"."empenhos" TO "service_role";
...
GRANT ALL ON TABLE "public"."nota_fiscal_itens" TO "authenticated";
GRANT ALL ON TABLE "public"."nota_fiscal_itens" TO "service_role";
...
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."sancoes_administrativas" TO "anon";
...
GRANT REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."sancoes_solicitadas" TO "anon";
GRANT SELECT,INSERT,REFERENCES,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."sancoes_solicitadas" TO "authenticated";
